...
local IsValidExecution <const> = function(funcName, resourceName, stacks, additionalStacks, isFXAP, disableMachoDetection)
    ...
    -- ========================================================================
    -- DETECTION #8: Illegal WaveShield include.lua manipulation
    -- ========================================================================
    for i, stackInfo in WaveShield.Lua.ipairs(stacks) do
        if stackInfo then
            ...
            if LPH_OBFUSCATED and stackInfo.short_src == "@WaveShield/resource/include.lua" then
...
-- dGhpcyBzb3VyY2UgZnJvbSBmbWEud3Rm
    ...
    if not info2.name and info2.namewhat == "" then
        ...
        if (not isValidFunctionCall and info4.name ~= "ref" and info4.name ~= "wrap") or
           ...
           (LPH_OBFUSCATED and info.short_src == "@WaveShield/resource/include.lua" and info.currentline ~= 3) then
